...
demo:
	...
	sleep 0.5 && \
	{ printf '$$ vllm-doctor --url http://localhost:8000\n\n'; NO_COLOR= FORCE_COLOR=1 CLICOLOR_FORCE=1 TERM=xterm-256color COLUMNS=120 uv run vllm-doctor --url http://localhost:8000; } \
