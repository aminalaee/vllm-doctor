...
class TestPrefixCacheEfficiencyRule:
    ...
    def test_custom_threshold(self) -> None:
        ...
        assert rule.run(Metrics(prefix_cache_hit_rate=0.8)) is None
        assert rule.run(Metrics(prefix_cache_hit_rate=0.79)) is not None
