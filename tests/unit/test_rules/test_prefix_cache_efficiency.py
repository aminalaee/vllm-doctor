...
class TestPrefixCacheEfficiencyRule:
    ...
    def test_custom_threshold(self) -> None:
        ...
        assert rule.run(_CTX, Metrics(prefix_cache_hit_rate=0.8)) == []
        assert len(rule.run(_CTX, Metrics(prefix_cache_hit_rate=0.79))) == 1
