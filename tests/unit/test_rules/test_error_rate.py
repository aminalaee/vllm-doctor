...
class TestErrorRateRule:
    ...
    def test_custom_thresholds(self) -> None:
        ...
        assert rule.run(_CTX, _metrics(90, 10, 0)) == []
        assert len(rule.run(_CTX, _metrics(70, 30, 0))) == 1
