...
use crate::core::models::RuleResult;
use crate::core::models::{Assessment, DiagnosisResult, Health};
...
mod tests {
    ...
    use crate::core::models::DiagnosisContext;
    ...
    fn registry_to_report_to_renderers() {
        ...
        let config = crate::core::config::CoreConfig::default();
        ...
        let text = crate::cli::reports::text::render(&report, &RenderOptions::default());
        assert!(text.contains("Health:"));
        assert!(text.contains("Queue pressure"));
        assert!(!text.contains("could not be evaluated"));

        let json = crate::cli::reports::json::render(&report, false);
