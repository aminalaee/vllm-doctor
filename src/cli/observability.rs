...
use crate::core::models::{DiagnosisResult, Health, InferenceEngine, Severity, TargetMetadata};
...
mod tests {
    ...
    use crate::core::models::{Confidence, DiagnosisContext, Finding, RuleResult};
