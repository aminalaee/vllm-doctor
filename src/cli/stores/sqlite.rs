...
static MIGRATOR: sqlx::migrate::Migrator = sqlx::migrate!("src/cli/stores/migrations");
...
mod tests {
    ...
    use crate::core::models::TargetMetadata;
    use crate::core::models::{DiagnosisContext, DiagnosisResult, InferenceEngine, MetricsSource};
    use crate::core::providers::{Provider, ProviderError, ProviderMetadata};
    ...
    async fn diagnose_result_persists_end_to_end() {
        ...
        let result = diagnose(
            ...
            "5m",
            None,
            &crate::core::models::TargetMetadata::default(),
            &config,
        )
        .await
        .unwrap();
