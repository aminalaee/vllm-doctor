...
use crate::metrics::{MODEL_LABEL, MetricSeriesSnapshot, evaluate_direct};

// `Signal` is generated by `define_metrics!` in `crate::metrics` and re-exported
// here so that the public path `crate::signals::Signal` stays stable.
pub use crate::metrics::Signal;
