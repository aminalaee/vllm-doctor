...
use crate::core::metrics::{MetricSeriesSnapshot, extract_by_output, series_by_output};
...
mod tests {
    ...
    use crate::core::metrics::{
        NO_DIMENSIONS, ObservationKind, ObservationRollup, ObservationUnit,
    };
    ...
    fn registry_invariants_match_expected_table() {
        use crate::core::metrics::Signal;
        use crate::core::metrics::{ObservationDimension, REPLICA_DIMENSION};
