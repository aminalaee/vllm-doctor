...
//! the database (sqlx), or any CLI concern. Applications construct a
//! [`CoreConfig`] at their integration boundary.
...
/// half of the configuration; callers add transport and storage settings
/// outside the diagnostic core.
#[derive(Debug, Clone, Default, Serialize, Deserialize, PartialEq)]
